...
enum scsi_host_status {
	...
	RH_KABI_BROKEN_REMOVE_ENUM(DID_TARGET_FAILURE = 0x10) /* Permanent target failure, do not retry on
							       * other paths */
	RH_KABI_BROKEN_REMOVE_ENUM(DID_NEXUS_FAILURE = 0x11)  /* Permanent nexus failure, retry on other
							       * paths might yield different results */
	RH_KABI_BROKEN_REMOVE_ENUM(DID_ALLOC_FAILURE = 0x12)  /* Space allocation on the device failed */
	RH_KABI_BROKEN_REMOVE_ENUM(DID_MEDIUM_ERROR = 0x13)   /* Medium error */
	/*
