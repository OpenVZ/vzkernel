...
#define QUEUE_FLAG_STANDBY      32      /* unable to handle read/write requests */
#define QUEUE_FLAG_STANDBY_EN   33      /* enable standby queue flag */
...
extern void bd_write_size(struct block_device *, sector_t sectors);
