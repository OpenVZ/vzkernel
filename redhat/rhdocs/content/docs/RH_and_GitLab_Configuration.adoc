...
To generate a new ssh-key pair on the command line, follow the instructions at https://docs.gitlab.com/ee/user/ssh.html#generate-an-ssh-key-pair[https://docs.gitlab.com/ee/user/ssh.html#generate-an-ssh-key-pair].

To add the ssh-key to a gitlab account, follow the instructions at https://docs.gitlab.com/ee/user/ssh.html#add-an-ssh-key-to-your-gitlab-account[https://docs.gitlab.com/ee/user/ssh.html#add-an-ssh-key-to-your-gitlab-account] to add an ssh key to your GitLab account.

To test that the ssh-key is configured properly, follow the instructions at https://docs.gitlab.com/ee/user/ssh.html#verify-that-you-can-connect[https://docs.gitlab.com/ee/user/ssh.html#verify-that-you-can-connect].
